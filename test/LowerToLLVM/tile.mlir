...
func.func @test_tile(%a: tensor<4x3x3xf32>) -> tensor<4x6x3xf32> {
   ...
   //CHECK-NEXT: %45 = llvm.insertvalue %15, %44[3, 0] : !llvm.struct<(ptr, ptr, i64, array<6 x i64>, array<6 x i64>)> 
   //CHECK-NEXT: %46 = llvm.insertvalue %16, %45[3, 1] : !llvm.struct<(ptr, ptr, i64, array<6 x i64>, array<6 x i64>)> 
