...
func.func @test_entr(%a: tensor<5x2x3xf32>) -> tensor<5x2x3xf32> {
    ...
    //CHECK-NEXT:    %6 = tosa.select %3, %arg0, %arg0 : (tensor<5x2x3xi1>, tensor<5x2x3xf32>, tensor<5x2x3xf32>) -> tensor<5x2x3xf32>
    ...
    //CHECK-NEXT:    %10 = tosa.select %4, %9, %9 : (tensor<5x2x3xi1>, tensor<5x2x3xf32>, tensor<5x2x3xf32>) -> tensor<5x2x3xf32>
    //CHECK-NEXT:    %11 = tosa.add %9, %10 : (tensor<5x2x3xf32>, tensor<5x2x3xf32>) -> tensor<5x2x3xf32>
    //CHECK-NEXT:    %12 = tosa.select %5, %11, %11 : (tensor<5x2x3xi1>, tensor<5x2x3xf32>, tensor<5x2x3xf32>) -> tensor<5x2x3xf32>
    //CHECK-NEXT:    %13 = tosa.add %11, %12 : (tensor<5x2x3xf32>, tensor<5x2x3xf32>) -> tensor<5x2x3xf32>
